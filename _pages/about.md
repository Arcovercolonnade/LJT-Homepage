...
- **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (2025) \*\\
  Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He, **Junteng Liu**. *arXiv, 2025.* (Code available on GitHub)
...
- **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024) \*\\
  **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. *Proceedings of EMNLP 2024.* (Code available on GitHub: Universal_Truthfulness_Hyperplane)
